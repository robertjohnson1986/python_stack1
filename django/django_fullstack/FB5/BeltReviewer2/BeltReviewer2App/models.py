...
class Reviews(models.Model):
    title = models.CharField(max_length=255, default="Robert")
    author = models.CharField(max_length=255, default="Text")
    reviewer =models.ForeignKey(User, related_name="reviews", on_delete=models.CASCADE)
    text = models.CharField(max_length=255, default="Robert")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
